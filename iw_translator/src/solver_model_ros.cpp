...
bool SolverModelROS::convertDesires(const hbba_msgs::DesiresSet& desires_set, 
                                    Vector& g,
                                    Vector& s) const
{
...
const std::string& SolverModelROS::strategyId(int i) const
{
    return mapId(strat_map_, i);
}

std::string SolverModelROS::uAsCSV() const
{
    return matrixAsCSV(u_, cls_map_);
}

std::string SolverModelROS::cAsCSV() const
{
    return matrixAsCSV(c_, res_map_);
}

std::string SolverModelROS::rAsCSV() const
{
    return matrixAsCSV(r_, cls_map_);
}

std::string SolverModelROS::urAsCSV() const
{
    return matrixAsCSV(ur_, cls_map_);
}

std::string SolverModelROS::matrixAsCSV(
    const Matrix& mtx, 
